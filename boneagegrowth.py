...
# 남아 BP 성장률 표 (예시, 실제 필요시 정확한 값 넣어야 함)
...
def main():
    ...
    if st.button("예측 시작") and image_file is not None:
        ...
        bone_age = pred.item() / 12  # 개월 단위 예측값을 연 단위로 변환
